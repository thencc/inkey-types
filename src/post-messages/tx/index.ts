...
export type InkeyTxPostMsgDefault = TxMsgGetStyleRecs | TxMsgInitComms | TxMsgSetApp | TxMsgSignTxnsRaw | TxMsgSignTxns | TxMsgConnect | TxMsgDisconnect | TxMsgReject | TxMsgSetVisibility;
